 ...
 * @generated
 */
public class ActivitydiagramDiagramActionBarContributor extends DiagramActionBarContributor {

	/**
	* @generated
	*/
	protected Class getEditorClass() {
		return ActivitydiagramDiagramEditor.class;
	}
	...
	*/
	protected String getEditorId() {
		return ActivitydiagramDiagramEditor.ID;
	}
