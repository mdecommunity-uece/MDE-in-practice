 ...
 * @generated
 */
public class ActivitydiagramModelingAssistantProvider extends ModelingAssistantProvider {
	...
	*/
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(Messages.ActivitydiagramModelingAssistantProviderMessage);
		dialog.setTitle(Messages.ActivitydiagramModelingAssistantProviderTitle);
