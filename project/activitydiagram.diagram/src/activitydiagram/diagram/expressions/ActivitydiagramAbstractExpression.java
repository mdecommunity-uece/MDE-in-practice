 ...
 * @generated
 */
public abstract class ActivitydiagramAbstractExpression {
	...
	*/
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ActivitydiagramDiagramEditorPlugin.ID;
	...
	* @generated
	*/
	protected ActivitydiagramAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
	...
	public Object evaluate(Object context, Map env) {
		if (context().isInstance(context)) {
			try {
				...
				ActivitydiagramDiagramEditorPlugin.getInstance().logError("Expression evaluation failure: " + body(), //$NON-NLS-1$
						e);
			}
		}
		return null;
