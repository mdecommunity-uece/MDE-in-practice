...
import activitydiagram.diagram.edit.commands.ActivitydiagramCreateShortcutDecorationsCommand;
import activitydiagram.diagram.edit.policies.ActivityDiagramCanonicalEditPolicy;
import activitydiagram.diagram.edit.policies.ActivityDiagramItemSemanticEditPolicy;
...
public class ActivityDiagramEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Activitydiagram"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ActivitydiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(new ActivitydiagramCreateShortcutDecorationsCommand(
