...
import activitydiagram.diagram.edit.policies.ActivitydiagramTextSelectionEditPolicy;
...
public class TransitionNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ActivitydiagramVisualIDRegistry
				.getType(activitydiagram.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ActivitydiagramTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitydiagramParserProvider.getParser(ActivitydiagramElementTypes.Transition_4001,
					getParserElement(), ActivitydiagramVisualIDRegistry
							.getType(activitydiagram.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ActivitydiagramEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
