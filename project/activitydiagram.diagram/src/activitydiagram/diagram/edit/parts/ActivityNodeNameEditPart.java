 ...
 * @generated
 */
public class ActivityNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ActivityNodeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ActivitydiagramParserProvider.getParser(ActivitydiagramElementTypes.ActivityNode_2003,
					getParserElement(), ActivitydiagramVisualIDRegistry
							.getType(activitydiagram.diagram.edit.parts.ActivityNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
