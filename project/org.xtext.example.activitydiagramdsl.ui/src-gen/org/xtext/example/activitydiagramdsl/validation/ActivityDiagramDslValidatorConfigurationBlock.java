 ...
 */
package org.xtext.example.activitydiagramdsl.validation;
...
public class ActivityDiagramDslValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(ActivityDiagramDslConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("ActivityDiagramDsl");
		if (section == null) {
			return dialogSettings.addNewSection("ActivityDiagramDsl");
		}
		return section;
	}
}
